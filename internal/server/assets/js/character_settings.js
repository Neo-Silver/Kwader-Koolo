...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateCharacterOptions() {
        ...
        const berserkerBarbOptions = document.querySelector('.berserker-barb-options');
        const wolfBarbOptions = document.querySelector('.wolf-barb-options');
        ...
        wolfBarbOptions.style.display = 'none';
        ...
        } else if (selectedClass === 'wolfbarb') {
            wolfBarbOptions.style.display = 'block';
